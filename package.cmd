...
python -m PyInstaller --onedir --noconfirm --windowed CODE\mark_estimator_experimental.py

echo.
echo Packaging complete. If you need to reverse this, delete the following items:
echo   dist\mark_estimator_experimental
echo   build
echo   mark_estimator_experimental.spec
